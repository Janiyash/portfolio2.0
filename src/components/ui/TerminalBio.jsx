...
const COMMANDS = {
  ...
  "yash --whoami": {
    output: [
      ...
      { text: "Built 6+ full-stack projects and ranked Top 32 nationally." },
  ...
  "yash --projects": {
      output: [
        { text: "[ 6 projects built ]", color: "var(--brass)" },
        ...
        { text: "  06 · Safelease      — property management & rental platform" },
        { text: "" },
  ...
  "yash --achievements": {
    output: [
      ...
      { text: "   • Built 6+ full-stack applications" },
